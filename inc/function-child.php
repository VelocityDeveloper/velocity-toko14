...
function velocitychild_theme_setup()
{
    ...
    if (class_exists('Kirki')) :
        ...
        Kirki::add_panel('panel_toko14', [
            'priority'    => 10,
            'title'       => esc_html__('Toko 14', 'justg'),
...
add_action('velocitytoko_product_loop', 'velocitytoko14_content_product', 30);
function velocitytoko14_content_product($post)
{
    ?>
        ...
        <div class="card h-100 card-product p-2 overflow-hidden">
            ...
            <div class="card-body text-center position-relative p-0">
                ...
                <div class="p-3 text-center">
                    <a class="btn btn-sm btn-primary fw-bold text-uppercase border-theme bg-theme shadow-sm" href="<?php echo get_the_permalink(); ?>">
                        Detail
                    </a>
